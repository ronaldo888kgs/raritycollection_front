            ...
            <nav className="main-nav " >
                <ul className={boxClass.join(' ')} style={{background: themes.light}}>
                    <li  className="menu-item" >
                        <NavLink exact activeClassName='is-active' onClick={toggleClass} to={`/`} style={{color: themes.gray['4']}}> Home </NavLink> 
                    </li>
                    <li className="menu-item " ><NavLink onClick={toggleClass} activeClassName='is-active' to={`/latest`} style={{color: themes.gray['4']}}> Latest </NavLink> </li>
                    <li className="menu-item " ><NavLink onClick={toggleClass} activeClassName='is-active' to={`/upcoming`} style={{color: themes.gray['4']}}> UpComing </NavLink> </li>
                    {/* {user.authenticated? */}
